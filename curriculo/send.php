   ...
   <?php
       ...
       if ($_POST['submit']) {
           ...
           echo '	   
			...
			<a href="index_esp.html" data-role="button" data-rel="back" data-theme="a">Close</a>       ';
				 
           } else {
           echo '
		   <h3>Message no enviado</h3>
		   <p>Por favor intenta luego</p>
			<a href="index_esp.html" data-role="button" data-rel="back" data-theme="c">Close</a> ';
           }
       }
    ?>
</div></div></div>
